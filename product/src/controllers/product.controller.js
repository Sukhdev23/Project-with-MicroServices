...
const { uploadImage, ImageKitAuthError } = require("../services/imagekit.service");
...
async function createProduct(req, res) {
  try {
    ...
    if (err instanceof ImageKitAuthError) {
      console.error("ImageKit auth failure while creating product", { message: err.message, help: err.help });
